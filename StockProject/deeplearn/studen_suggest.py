...
def suggest_start(new_data , n_days , first_suggest = 0, first_date = 0, first_add_date = 0, first_train = 0, first_pred = 0):
    ...
    if first_suggest == 1:
        plotly_div_result = studen_deep_linear.draw_plotly(np_time_data , X_X, new_time_data, X_pred, first_date, first_pred, n, axis = 1 , name = '預測結果')
        plotly_div = studen_deep_linear.draw_plotly(np_time_data , X_X, np_time_data[:len(np_time_data)-30], pred , first_add_date[:len(first_add_date)-30], first_train, 30, axis = 0 , name = '訓練結果')
    ...
    if __name__ == "__main__":
        ...
        if first_suggest == 1:
            ...
            return new_time_data , np_time_data , X_pred , pred
