...
if __name__ == "__main__":
    ...
    n_days = len(new_data)  
    suggest , X_pred , pred , np_time_data , X_X , new_time_data , Y_Y , model = suggest_start(new_data , n_days , first_suggest = 0)
    suggest , X_pred , pred , np_time_data , X_X , new_time_data , Y_Y , model = suggest_start(new_data , n_days , first_suggest = 1 , first_train = X_pred , first_pred = pred)
    n = 30
